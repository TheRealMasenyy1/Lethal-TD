...
local Cosmicbracken = {}
Cosmicbracken.__index = setmetatable(Cosmicbracken,UnitManager)


function Cosmicbracken.Setup(Unit)
	local self = UnitManager.new(Unit)
	setmetatable(self,Cosmicbracken)
	...
	-- self.AttackSound = self:LoadSound(EntityInfo["Bracken"].Sound)
	
	--- Empty Constructor
	return self
end

function Cosmicbracken:Attack()
